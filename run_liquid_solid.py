...
def main():
    ...
    # Use a 3 phase liquid extraction COSMOtherm input file, specify which phases are water, oil and solid in the phase_types variable
    # and specify which user is running the script in the user variable.
